...
import static cn.bingoogolapple.qrcode.core.BGAQRCodeUtil.dp2px;
...
//        int width = dp2px(getContext(), 200);
//        int height = dp2px(getContext(), 90);
//        int topmargin = dp2px(getContext(), 100);
//
//
